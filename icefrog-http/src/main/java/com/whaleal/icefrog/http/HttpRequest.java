...
import com.whaleal.icefrog.core.io.resource.BytesResource;
...
import com.whaleal.icefrog.http.body.MultipartBody;
...
public class HttpRequest extends HttpBase<HttpRequest> {
	 ...
	 * <p>
	 * 相关issue见：https://github.com/loolly/icefrog/issues/IMD1X
	 *
	...
	/**
	 * 设置Cookie<br>
	 * 自定义Cookie后会覆盖icefrog的默认Cookie行为
	 *
	 ...
	 * 2. Rest模式，此时body需要传入一个JSON或者XML字符串，icefrog会自动绑定其对应的Content-Type
	 * </pre>
	 *
	 * @param body 请求体
	 * @return this
