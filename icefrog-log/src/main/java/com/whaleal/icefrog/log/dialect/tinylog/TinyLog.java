...
public class TinyLog extends AbstractLog {
    ...
    @Override
    public boolean isEnabled( com.whaleal.icefrog.log.level.Level level ) {
    ...
    /**
     * 将icefrog的Level等级转换为Tinylog的Level等级
     *
     * @param level icefrog的Level等级
     * @return Tinylog的Level
     * @since 1.0.0
     */
    private Level toTinyLevel( com.whaleal.icefrog.log.level.Level level ) {
        Level tinyLevel;
        switch (level) {
            case TRACE:
