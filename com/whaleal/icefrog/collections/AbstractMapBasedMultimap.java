...
abstract class AbstractMapBasedMultimap<K extends Object, V extends Object>
     ...
     * ancestor field poNumberUtil to the full wrapped collection with all values for the key. The
    ...
    private abstract class Itr<T extends Object> implements Iterator<T> {
        ...
        public T next() {
            ...
            /*
             *  is safe: The first call to this method always enters the !hasNext() case and
    ...
    private class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        Entry<K, Collection<V>> wrapEntry( Entry<K, Collection<V>> entry ) {
            K key = entry.getKey();
            return new ImmutableEntry(key, wrapCollection(key, entry.getValue()));
        }
    ...
    class NavigableAsMap extends SortedAsMap implements NavigableMap<K, Collection<V>> {
        ...
        Entry<K, Collection<V>> pollAsMapEntry( Iterator<Entry<K, Collection<V>>> entryIterator ) {
            ...
            entryIterator.remove();
            return new ImmutableEntry(entry.getKey(), unmodifiableCollectionSubclass(output));
        }
