 ...
 *
 * <p>The methods returning collections or MapUtil always return views of the underlying table.
...
public interface Table<
     ...
     *
     * <p>In contrast, the MapUtil returned by {@code rowMap().get()} have the same behavior as those
     * returned by {@link #row}. Those MapUtil may support {@code setValue()}, {@code put()}, and {@code
     * putAll()}.
     *
     ...
     * {@code put()} or {@code putAll()}, or {@code setValue()} on its entries.
     *
     * <p>In contrast, the MapUtil returned by {@code columnMap().get()} have the same behavior as those
     * returned by {@link #column}. Those MapUtil may support {@code setValue()}, {@code put()}, and
     * {@code putAll()}.
     *
    ...
    interface Cell<
         ...
         *
         * <p>The hash code of a table cell is equal to {@link ObjectUtil#hashCode}{@code (e.getRowKey(),
