...
public class HexUtil {
	 ...
	 * @throws DecoderException 异常处理
	 */
	public static byte[] decodeHex(String hexStr) throws DecoderException {
	 ...
	 * @param hexData 十六进制char[]
	 * @return byte[]
	 * @throws DecoderException 异常处理  RuntimeException 如果源十六进制字符数组是一个奇怪的长度，将抛出运行时异常
	 */
	public static byte[] decodeHex(char[] hexData) throws DecoderException {
	...
	private static char[] encodeHex(byte[] data, char[] toDigits) {
		return Hex.encodeHex(data,toDigits);
	}
