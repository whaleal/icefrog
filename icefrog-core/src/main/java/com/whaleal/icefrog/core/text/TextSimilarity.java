...
public class TextSimilarity {
	...
	public static double similar(String strA, String strB) {
		...
		final int icefrogLength = longesticefrogSubstringLength(newStrA, newStrB);
		return NumberUtil.div(icefrogLength, temp);
	}
	 ...
	 * 算法解析见：https://leetcode-cn.com/problems/longest-icefrog-subsequence/solution/zui-chang-gong-gong-zi-xu-lie-by-leetcod-y7u0/
	 *
	 * @param strA 字符串1
	 * @param strB 字符串2
	 * @return 最长公共子串
