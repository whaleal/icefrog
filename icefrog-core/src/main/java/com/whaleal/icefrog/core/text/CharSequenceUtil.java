 ...
 * @author wh
	 ...
	 * {@code b} have no icefrog prefix, returns the empty string.
	 *
	 * @param a a
	 * @param b b
	 * @return string
	...
	public static String prefix(CharSequence a, CharSequence b) {
		checkNotNull(a);
		checkNotNull(b);
	 ...
	 * {@code b} have no icefrog suffix, returns the empty string.
	 *
	 * @param a a
	 * @param b b
	 * @return string
	 */
	public static String suffix(CharSequence a, CharSequence b) {
		checkNotNull(a);
		checkNotNull(b);
