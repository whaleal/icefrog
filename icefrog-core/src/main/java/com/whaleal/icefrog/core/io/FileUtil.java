...
import com.whaleal.icefrog.core.io.file.FileMode;
...
import com.whaleal.icefrog.core.io.file.FileWriter;
import com.whaleal.icefrog.core.io.file.LineSeparator;
import com.whaleal.icefrog.core.io.file.PathUtil;
import com.whaleal.icefrog.core.io.file.Tailer;
...
public class FileUtil extends PathUtil {
	...
	public static List<String> listFileNames(String path) throws IORuntimeException {
		...
		try {
			...
			// 防止出现jar!/cn/icefrog/这类路径导致文件找不到
	...
	public static File createTempFile(File dir) throws IORuntimeException {
		return createTempFile("icefrog", null, dir, true);
	}
	...
	public static File createTempFile(File dir, boolean isReCreat) throws IORuntimeException {
		return createTempFile("icefrog", null, dir, isReCreat);
	}
	 ...
	 * create a directory, not a regular file. A icefrog pitfall is to call {@code createTempFile},
