...
public abstract class Tuple extends CloneSupport<Tuple> implements Iterable<Object>, Serializable {
    ...
    public final Tuple subTuple(final int start, final int end) {
        ...
        switch (length) {
            case 1:
                return Tuple1.of(this.valueList.get(start));
            case 2:
                return Tuple2.of(this.valueList.get(start), this.valueList.get(end));
            case 3:
                return Tuple3.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(end));
            case 4:
                return Tuple4.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(start + 2), this.valueList.get(end));
            case 5:
                return Tuple5.of(this.valueList.get(start), this.valueList.get(start + 1), this.valueList.get(start + 2), this.valueList.get(start + 3), this.valueList.get(end));
            default:
                return TupleN.of(this.valueList.subList(start, end));
        }
    }
    ...
    public final Tuple add(final Tuple... tuples) {
        ...
        switch (temp.size()) {
            case 1:
                return Tuple1.of(temp.get(0));
            case 2:
                return Tuple2.of(temp.get(0), temp.get(1));
            case 3:
                return Tuple3.of(temp.get(0), temp.get(1), temp.get(2));
            case 4:
                return Tuple4.of(temp.get(0), temp.get(1), temp.get(2), temp.get(3));
            case 5:
                return Tuple5.of(temp.get(0), temp.get(1), temp.get(2), temp.get(3), temp.get(4));
            default:
                return TupleN.of(temp.toArray());
        }
    }
    ...
    public final Tuple add(final Object... objs) {
        ...
        return this.add(TupleN.of(objs));
    }
    ...
    public final Tuple repeat(final int times) {
        ...
        if (times == 0)
            return this;
        return TupleN.of(IntStream.range(0, times)
