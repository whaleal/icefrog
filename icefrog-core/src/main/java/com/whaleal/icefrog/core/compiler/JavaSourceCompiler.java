...
import com.whaleal.icefrog.core.io.resource.StringResource;
 ...
 *         .addSource(FileUtil.file("testcompile/b/B.java"))
 *         .addSource("c.C", FileUtil.readUtf8String("testcompile/c/C.java"))
 *         // 增加编译依赖的类库
 *         .addLibrary(libFile)
 *         .compile();
