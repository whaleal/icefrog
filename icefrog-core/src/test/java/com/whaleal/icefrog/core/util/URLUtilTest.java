...
public class URLUtilTest {
	...
	public void normalizeTest() {
		// issue#I25MZL，多个/被允许
		String url = "http://www.icefrog.cn//aaa/bbb";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.icefrog.cn//aaa/bbb", normalize);

		url = "www.icefrog.cn//aaa/bbb";
	...
	public void normalizeTest2() {
		String url = "http://www.icefrog.cn//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.icefrog.cn//aaa//bbb?a=1&b=2", normalize);

		url = "www.icefrog.cn//aaa/bbb?a=1&b=2";
		normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.icefrog.cn//aaa/bbb?a=1&b=2", normalize);
	}
	...
	public void formatTest() {
		String url = "//www.icefrog.cn//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		Assert.assertEquals("http://www.icefrog.cn//aaa//bbb?a=1&b=2", normalize);
	}
	...
	public void getHostTest() throws MalformedURLException {
		String url = "https://www.icefrog.cn//aaa/\\bbb?a=1&b=2";
		String normalize = URLUtil.normalize(url);
		URI host = URLUtil.getHost(new URL(normalize));
		Assert.assertEquals("https://www.icefrog.cn", host.toString());
	}
