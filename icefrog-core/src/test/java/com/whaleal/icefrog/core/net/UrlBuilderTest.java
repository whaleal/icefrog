...
public class UrlBuilderTest {
    ...
    public void buildTest() {
        String buildUrl = UrlBuilder.create().setHost("www.icefrog.cn").build();
        Assert.assertEquals("http://www.icefrog.cn/", buildUrl);
    }

    @Test
    public void buildTest2() {
        // path中的+不做处理
        String buildUrl = UrlBuilder.ofHttp("http://www.icefrog.cn/+8618888888888", CharsetUtil.CHARSET_UTF_8).build();
        Assert.assertEquals("http://www.icefrog.cn/+8618888888888", buildUrl);
    }
    ...
    public void testHost() {
        String buildUrl = UrlBuilder.create()
                .setScheme("https")
                .setHost("www.icefrog.cn").build();
        Assert.assertEquals("https://www.icefrog.cn/", buildUrl);
    }
    ...
    public void testHostPort() {
        String buildUrl = UrlBuilder.create()
                .setScheme("https")
                .setHost("www.icefrog.cn")
                .setPort(8080)
                .build();
        Assert.assertEquals("https://www.icefrog.cn:8080/", buildUrl);
    }
    ...
    public void testPathAndQuery() {
        ...
        Assert.assertEquals("https://www.icefrog.cn/aaa/bbb?ie=UTF-8&wd=test", buildUrl);
    }
    ...
    public void testQueryWithChinese() {
        ...
        Assert.assertEquals("https://www.icefrog.cn/aaa/bbb?ie=UTF-8&wd=%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testMultiQueryWithChinese() {
        ...
        Assert.assertEquals("https://www.icefrog.cn/s?ie=UTF-8&ie=GBK&wd=%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testFragment() {
        ...
        Assert.assertEquals("https://www.icefrog.cn/#abc", buildUrl);
    }
    ...
    public void testChineseFragment() {
        ...
        Assert.assertEquals("https://www.icefrog.cn/#%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testChineseFragmentWithPath() {
        String buildUrl = new UrlBuilder()
                ...
                .addPath("/s")
                .setFragment("测试").build();
        Assert.assertEquals("https://www.icefrog.cn/s#%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testChineseFragmentWithPathAndQuery() {
        String buildUrl = new UrlBuilder()
                ...
                .addQuery("wd", "test")
                .setFragment("测试").build();
        Assert.assertEquals("https://www.icefrog.cn/s?wd=test#%E6%B5%8B%E8%AF%95", buildUrl);
    }

    @Test
    public void ofTest() {
        final UrlBuilder builder = UrlBuilder.of("http://www.icefrog.cn/aaa/bbb/?a=1&b=2#frag1", CharsetUtil.CHARSET_UTF_8);
        Assert.assertEquals("http", builder.getScheme());
        Assert.assertEquals("www.icefrog.cn", builder.getHost());
    ...
    public void ofWithChineseTest() {
        final UrlBuilder builder = UrlBuilder.ofHttp("www.icefrog.cn/aaa/bbb/?a=张三&b=%e6%9d%8e%e5%9b%9b#frag1", CharsetUtil.CHARSET_UTF_8);
        Assert.assertEquals("http", builder.getScheme());
        Assert.assertEquals("www.icefrog.cn", builder.getHost());
    ...
    public void ofSpecialTest() {
        ...
        final UrlBuilder builder = UrlBuilder.ofHttp(" www.icefrog.cn/aaa/bbb/?a=张三&b=%%e5%9b%9b#frag1", CharsetUtil.CHARSET_UTF_8);
        Assert.assertEquals("http", builder.getScheme());
        Assert.assertEquals("www.icefrog.cn", builder.getHost());
    ...
    public void endWithSlashTest() {
        // 原URL中以/结尾，则这个规则需保留，issue#I1G44J@github
    ...
    public void multiSlashTest() {
        ...
        final UrlBuilder urlBuilder = UrlBuilder.ofHttp("https://icefrog.cn//file/test.jpg", CharsetUtil.CHARSET_UTF_8);
        Assert.assertEquals("https://icefrog.cn//file/test.jpg", urlBuilder.toString());
    }
