...
import com.whaleal.icefrog.core.comparator.ComparableComparator;
...
public class CollUtilTest {
    ...
    public void testPredicateContains() {
        ...
        Assert.assertTrue(CollUtil.contains(list, new Predicate<String>() {
            @Override
        ...
        Assert.assertFalse(CollUtil.contains(list, new Predicate<String>() {
            @Override
            public boolean apply( String input ) {
    ...
    public void cartesianProductTest(){
        List<List<String>> lists = CollUtil.cartesianProduct(CollUtil.newArrayList("a", "b"), CollUtil.newArrayList("0", "1", "2"));

        System.out.println(ArrayUtil.toString(lists.toArray()));
        Assert.assertEquals(lists.size(),2*3);
        Assert.assertEquals(lists.get(0).size(),2);

    }

    @Test
    public void cartesianProductTest2(){
        //CollUtil.newArrayList("a", "b"), CollUtil.newArrayList("0", "1", "2")
        //CollUtil.newArrayList(CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2")

        List<List<String>> lists = CollUtil.cartesianProduct(CollUtil.newArrayList("a", "b"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"));
        //[[a, 0, 0, 0, 0, 0], [a, 0, 0, 0, 0, 1], [a, 0, 0, 0, 0, 2], [a, 0, 0, 0, 1, 0], [a, 0, 0, 0, 1, 1], [a, 0, 0, 0, 1, 2], [a, 0, 0, 0, 2, 0], [a, 0, 0, 0, 2, 1], [a, 0, 0, 0, 2, 2], [a, 0, 0, 1, 0, 0], [a, 0, 0, 1, 0, 1], [a, 0, 0, 1, 0, 2], [a, 0, 0, 1, 1, 0], [a, 0, 0, 1, 1, 1], [a, 0, 0, 1, 1, 2], [a, 0, 0, 1, 2, 0], [a, 0, 0, 1, 2, 1], [a, 0, 0, 1, 2, 2], [a, 0, 0, 2, 0, 0], [a, 0, 0, 2, 0, 1], [a, 0, 0, 2, 0, 2], [a, 0, 0, 2, 1, 0], [a, 0, 0, 2, 1, 1], [a, 0, 0, 2, 1, 2], [a, 0, 0, 2, 2, 0], [a, 0, 0, 2, 2, 1], [a, 0, 0, 2, 2, 2], [a, 0, 1, 0, 0, 0], [a, 0, 1, 0, 0, 1], [a, 0, 1, 0, 0, 2], [a, 0, 1, 0, 1, 0], [a, 0, 1, 0, 1, 1], [a, 0, 1, 0, 1, 2], [a, 0, 1, 0, 2, 0], [a, 0, 1, 0, 2, 1], [a, 0, 1, 0, 2, 2], [a, 0, 1, 1, 0, 0], [a, 0, 1, 1, 0, 1], [a, 0, 1, 1, 0, 2], [a, 0, 1, 1, 1, 0], [a, 0, 1, 1, 1, 1], [a, 0, 1, 1, 1, 2], [a, 0, 1, 1, 2, 0], [a, 0, 1, 1, 2, 1], [a, 0, 1, 1, 2, 2], [a, 0, 1, 2, 0, 0], [a, 0, 1, 2, 0, 1], [a, 0, 1, 2, 0, 2], [a, 0, 1, 2, 1, 0], [a, 0, 1, 2, 1, 1], [a, 0, 1, 2, 1, 2], [a, 0, 1, 2, 2, 0], [a, 0, 1, 2,
 2], [a, 2, 2, 1, 1, 0], [a, 2, 2, 1, 1, 1], [a, 2, 2, 1, 1, 2], [a, 2, 2, 1, 2, 0], [a, 2, 2, 1, 2, 1], [a, 2, 2, 1, 2, 2], [a, 2, 2, 2, 0, 0], [a, 2, 2, 2, 0, 1], [a, 2, 2, 2, 0, 2], [a, 2, 2, 2, 1, 0], [a, 2, 2, 2, 1, 1], [a, 2, 2, 2, 1, 2], [a, 2, 2, 2, 2, 0], [a, 2, 2, 2, 2, 1], [a, 2, 2, 2, 2, 2], [b, 0, 0, 0, 0, 0], [b, 0, 0, 0, 0, 1], [b, 0, 0, 0, 0, 2], [b, 0, 0, 0, 1, 0], [b, 0, 0, 0, 1, 1], [b, 0, 0, 0, 1, 2], [b, 0, 0, 0, 2, 0], [b, 0, 0, 0, 2, 1], [b, 0, 0, 0, 2, 2], [b, 0, 0, 1, 0, 0], [b, 0, 0, 1, 0, 1], [b, 0, 0, 1, 0, 2], [b, 0, 0, 1, 1, 0], [b, 0, 0, 1, 1, 1], [b, 0, 0, 1, 1, 2], [b, 0, 0, 1, 2, 0], [b, 0, 0, 1, 2, 1], [b, 0, 0, 1, 2, 2], [b, 0, 0, 2, 0, 0], [b, 0, 0, 2, 0, 1], [b, 0, 0, 2, 0, 2], [b, 0, 0, 2, 1, 0], [b, 0, 0, 2, 1, 1], [b, 0, 0, 2, 1, 2], [b, 0, 0, 2, 2, 0], [b, 0, 0, 2, 2, 1], [b, 0, 0, 2, 2, 2], [b, 0, 1, 0, 0, 0], [b, 0, 1, 0, 0, 1], [b, 0, 1, 0, 0, 2], [b, 0, 1, 0, 1, 0], [b, 0, 1, 0, 1, 1], [b, 0, 1, 0, 1, 2], [b, 0, 1, 0, 2, 0], [b, 0, 1, 0, 2, 1], [b, 0, 1, 0, 2, 2], [b, 0, 1, 1, 0, 0], [b, 0, 1, 1, 0, 1], [b, 0, 1, 1, 0, 2], [b, 0, 1, 1, 1, 0], [b, 0, 1, 1, 1, 1], [b, 0, 1, 1, 1, 2], [b, 0, 1, 1, 2, 0], [b, 0, 1, 1, 2, 1], [b, 0, 1, 1, 2, 2], [b, 0, 1, 2, 0, 0], [b, 0, 1, 2, 0, 1], [b, 0, 1, 2, 0, 2], [b, 0, 1, 2, 1, 0], [b, 0, 1, 2, 1, 1], [b, 0, 1, 2, 1, 2], [b, 0, 1, 2, 2, 0], [b, 0, 1, 2, 2, 1], [b, 0, 1, 2, 2, 2], [b, 0, 2, 0, 0, 0], [b, 0, 2, 0, 0, 1], [b, 0, 2, 0, 0, 2], [b, 0, 2, 0, 1, 0], [b, 0, 2, 0, 1, 1], [b, 0, 2, 0, 1, 2], [b, 0, 2, 0, 2, 0], [b, 0, 2, 0, 2, 1], [b, 0, 2, 0, 2, 2], [b, 0, 2, 1, 0, 0], [b, 0, 2, 1, 0, 1], [b, 0, 2, 1, 0, 2], [b, 0, 2, 1, 1, 0], [b, 0, 2, 1, 1, 1], [b, 0, 2, 1, 1, 2], [b, 0, 2, 1, 2, 0], [b, 0, 2, 1, 2, 1], [b, 0, 2, 1, 2, 2], [b, 0, 2, 2, 0, 0], [b, 0, 2, 2, 0, 1], [b, 0, 2, 2, 0, 2], [b, 0, 2, 2, 1, 0], [b, 0, 2, 2, 1, 1], [b, 0, 2, 2, 1, 2], [b, 0, 2, 2, 2, 0], [b, 0, 2, 2, 2, 1], [b, 0, 2, 2, 2, 2], [b, 1, 0, 0, 0, 0], [b, 1, 0, 0, 0, 1], [b, 1, 0, 0, 0, 2], [b, 1, 0, 0, 1, 0], [b, 1, 0, 0, 1, 1], [b, 1, 0, 0, 1, 2], [b, 1, 0, 0, 2, 0], [b, 1, 0, 0, 2, 1], [b, 1, 0, 0, 2, 2], [b, 1, 0, 1, 0, 0], [b, 1, 0, 1, 0, 1], [b, 1, 0, 1, 0, 2], [b, 1, 0, 1, 1, 0], [b, 1, 0, 1, 1, 1], [b, 1, 0, 1, 1, 2], [b, 1, 0, 1, 2, 0], [b, 1, 0, 1, 2, 1], [b, 1, 0, 1, 2, 2], [b, 1, 0, 2, 0, 0], [b, 1, 0, 2, 0, 1], [b, 1, 0, 2, 0, 2], [b, 1, 0, 2, 1, 0], [b, 1, 0, 2, 1, 1], [b, 1, 0, 2, 1, 2], [b, 1, 0, 2, 2, 0], [b, 1, 0, 2, 2, 1], [b, 1, 0, 2, 2, 2], [b, 1, 1, 0, 0, 0], [b, 1, 1, 0, 0, 1], [b, 1, 1, 0, 0, 2], [b, 1, 1, 0, 1, 0], [b, 1, 1, 0, 1, 1], [b, 1, 1, 0, 1, 2], [b, 1, 1, 0, 2, 0], [b, 1, 1, 0, 2, 1], [b, 1, 1, 0, 2, 2], [b, 1, 1, 1, 0, 0], [b, 1, 1, 1, 0, 1], [b, 1, 1, 1, 0, 2], [b, 1, 1, 1, 1, 0], [b, 1, 1, 1, 1, 1], [b, 1, 1, 1, 1, 2], [b, 1, 1, 1, 2, 0], [b, 1, 1, 1, 2, 1], [b, 1, 1, 1, 2, 2], [b, 1, 1, 2, 0, 0], [b, 1, 1, 2, 0, 1], [b, 1, 1, 2, 0, 2], [b, 1, 1, 2, 1, 0], [b, 1, 1, 2, 1, 1], [b, 1, 1, 2, 1, 2], [b, 1, 1, 2, 2, 0], [b, 1, 1, 2, 2, 1], [b, 1, 1, 2, 2, 2], [b, 1, 2, 0, 0, 0], [b, 1, 2, 0, 0, 1], [b, 1, 2, 0, 0, 2], [b, 1, 2, 0, 1, 0], [b, 1, 2, 0, 1, 1], [b, 1, 2, 0, 1, 2], [b, 1, 2, 0, 2, 0], [b, 1, 2, 0, 2, 1], [b, 1, 2, 0, 2, 2], [b, 1, 2, 1, 0, 0], [b, 1, 2, 1, 0, 1], [b, 1, 2, 1, 0, 2], [b, 1, 2, 1, 1, 0], [b, 1, 2, 1, 1, 1], [b, 1, 2, 1, 1, 2], [b, 1, 2, 1, 2, 0], [b, 1, 2, 1, 2, 1], [b, 1, 2, 1, 2, 2], [b, 1, 2, 2, 0, 0], [b, 1, 2, 2, 0, 1], [b, 1, 2, 2, 0, 2], [b, 1, 2, 2, 1, 0], [b, 1, 2, 2, 1, 1], [b, 1, 2, 2, 1, 2], [b, 1, 2, 2, 2, 0], [b, 1, 2, 2, 2, 1], [b, 1, 2, 2, 2, 2], [b, 2, 0, 0, 0, 0], [b, 2, 0, 0, 0, 1], [b, 2, 0, 0, 0, 2], [b, 2, 0, 0, 1, 0], [b, 2, 0, 0, 1, 1], [b, 2, 0, 0, 1, 2], [b, 2, 0, 0, 2, 0], [b, 2, 0, 0, 2, 1], [b, 2, 0, 0, 2, 2], [b, 2, 0, 1, 0, 0], [b, 2, 0, 1, 0, 1], [b, 2, 0, 1, 0, 2], [b, 2, 0, 1, 1, 0], [b, 2, 0, 1, 1, 1], [b, 2, 0, 1, 1, 2], [b, 2, 0, 1, 2, 0], [b, 2, 0, 1, 2, 1], [b, 2, 0, 1, 2, 2], [b, 2, 0, 2, 0, 0], [b, 2, 0, 2, 0, 1], [b, 2, 0, 2, 0, 2], [b, 2, 0, 2, 1, 0], [b, 2, 0, 2, 1, 1], [b, 2, 0, 2, 1, 2], [b, 2, 0, 2, 2, 0], [b, 2, 0, 2, 2, 1], [b, 2, 0, 2, 2, 2], [b, 2, 1, 0, 0, 0], [b, 2, 1, 0, 0, 1], [b, 2, 1, 0, 0, 2], [b, 2, 1, 0, 1, 0], [b, 2, 1, 0, 1, 1], [b, 2, 1, 0, 1, 2], [b, 2, 1, 0, 2, 0], [b, 2, 1, 0, 2, 1], [b, 2, 1, 0, 2, 2], [b, 2, 1, 1, 0, 0], [b, 2, 1, 1, 0, 1], [b, 2, 1, 1, 0, 2], [b, 2, 1, 1, 1, 0], [b, 2, 1, 1, 1, 1], [b, 2, 1, 1, 1, 2], [b, 2, 1, 1, 2, 0], [b, 2, 1, 1, 2, 1], [b, 2, 1, 1, 2, 2], [b, 2, 1, 2, 0, 0], [b, 2, 1, 2, 0, 1], [b, 2, 1, 2, 0, 2], [b, 2, 1, 2, 1, 0], [b, 2, 1, 2, 1, 1], [b, 2, 1, 2, 1, 2], [b, 2, 1, 2, 2, 0], [b, 2, 1, 2, 2, 1], [b, 2, 1, 2, 2, 2], [b, 2, 2, 0, 0, 0], [b, 2, 2, 0, 0, 1], [b, 2, 2, 0, 0, 2], [b, 2, 2, 0, 1, 0], [b, 2, 2, 0, 1, 1], [b, 2, 2, 0, 1, 2], [b, 2, 2, 0, 2, 0], [b, 2, 2, 0, 2, 1], [b, 2, 2, 0, 2, 2], [b, 2, 2, 1, 0, 0], [b, 2, 2, 1, 0, 1], [b, 2, 2, 1, 0, 2], [b, 2, 2, 1, 1, 0], [b, 2, 2, 1, 1, 1], [b, 2, 2, 1, 1, 2], [b, 2, 2, 1, 2, 0], [b, 2, 2, 1, 2, 1], [b, 2, 2, 1, 2, 2], [b, 2, 2, 2, 0, 0], [b, 2, 2, 2, 0, 1], [b, 2, 2, 2, 0, 2], [b, 2, 2, 2, 1, 0], [b, 2, 2, 2, 1, 1], [b, 2, 2, 2, 1, 2], [b, 2, 2, 2, 2, 0], [b, 2, 2, 2, 2, 1], [b, 2, 2, 2, 2, 2]]
        System.out.println(ArrayUtil.toString(lists.toArray()));

        Assert.assertEquals(lists.size(),2*3*3*3*3*3);
        Assert.assertEquals(lists.get(0).size(),6);
