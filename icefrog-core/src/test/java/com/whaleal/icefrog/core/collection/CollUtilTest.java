...
public class CollUtilTest {
    ...
    public void cartesianProductTest2(){
        ...
        //ArrayList<List<String>> strings = CollUtil.newArrayList(CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"), CollUtil.newArrayList("0", "1", "2"));
