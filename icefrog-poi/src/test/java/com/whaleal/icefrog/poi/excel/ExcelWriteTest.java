...
import com.whaleal.icefrog.poi.excel.cell.setters.EscapeStrCellSetter;
...
//		row2.put("age", 233);
	...
	public void writeBeanTest() {
		com.whaleal.icefrog.poi.excel.TestBean bean1 = new com.whaleal.icefrog.poi.excel.TestBean();
		bean1.setName("张三");
		bean1.setAge(22);
		bean1.setPass(true);
		...
		com.whaleal.icefrog.poi.excel.TestBean bean2 = new com.whaleal.icefrog.poi.excel.TestBean();
		bean2.setName("李四");
		bean2.setAge(28);
		bean2.setPass(false);
		...
		List<com.whaleal.icefrog.poi.excel.TestBean> rows = CollUtil.newArrayList(bean1, bean2);
		// 通过工具类创建writer
	...
	public void writeBeanTest2() {
		com.whaleal.icefrog.poi.excel.OrderExcel order1 = new com.whaleal.icefrog.poi.excel.OrderExcel();
		order1.setId("1");
		order1.setNum("123");
		order1.setBody("body1");

		com.whaleal.icefrog.poi.excel.OrderExcel order2 = new com.whaleal.icefrog.poi.excel.OrderExcel();
		order1.setId("2");
		order1.setNum("456");
		order1.setBody("body2");

		List<com.whaleal.icefrog.poi.excel.OrderExcel> rows = CollUtil.newArrayList(order1, order2);
		// 通过工具类创建writer
	...
	public void mergeTest3(){
		// https://github.com/whaleal/icefrog/issues/1696
	...
	public void issueI466ZZTest(){
		// https://github.com/whaleal/icefrog/issues/I466ZZ
