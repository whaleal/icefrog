...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
     ...
     * {@code upper} (exclusive). If the endpoNumberUtil are equal, an empty set is returned. (These are the
     ...
     * /**
     * // NavigableSet
     * @Override public ContiguousSet<C> subSet(
    ...
    /**
     * Returns a range, closed on both ends, whose endpoNumberUtil are the minimum and maximum values
     ...
     *
     * <p>Note that this method will return ranges with unbounded endpoNumberUtil if {@link BoundType#OPEN}
