 ...
 // Array.newInstance(Class, int)
  ...
  private static <E extends Object> Collection<E> castOrCopyToCollection(
    ...
    return (iterable instanceof Collection)
        ...
        : ListUtil.list(false,iterable.iterator());
  }
   ...
   * That is, this method behaves exactly as {@code Iterables.cycle(ListUtil.list(false,elements))}.
  ...
  public static <T extends Object> Iterable<T> filter(
    ...
    return new FluentIterable<T>() {
      ...
      @Override
      public Spliterator<T> spliterator() {
        return SpliteratorUtil.filter(unfiltered.spliterator(), retainIfTrue);
      }
    };
  }
