...
public interface RangeMap<K extends Comparable, V> {
  ...
  /**
   * MapUtil a range to a specified value (optional operation).
   *
  ...
  /**
   * MapUtil a range to a specified value, coalescing this range with any existing ranges with the same
   ...
   * may be expensive depending on the value type. Using this method on range MapUtil with large values
