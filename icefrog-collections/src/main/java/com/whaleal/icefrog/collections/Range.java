 ...
 * </blockquote>
 *
 * <p>When both endpoNumberUtil exist, the upper endpoint may not be less than the lower. The endpoNumberUtil
...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies
    ...
    public Range<C> gap( Range<C> otherRange ) {
         ...
         * than "less than or equal to" because of *handwave* the difference between "endpoNumberUtil of
    ...
    /**
     * Returns {@code true} if {@code object} is a range having the same endpoNumberUtil and bound types as
