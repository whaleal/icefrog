...
import static com.whaleal.icefrog.core.map.MapUtil.keyOrNull;
...
public final class ImmutableSortedMap<K, V> extends ImmutableSortedMapFauxverideShim<K, V>
  ...
  /**
   * Returns a builder that creates immutable sorted MapUtil whose keys are ordered by their natural
   * ordering. The sorted MapUtil use {@link Ordering#natural()} as the comparator.
   */
  ...
  /**
   * Returns a builder that creates immutable sorted MapUtil with an explicit comparator. If the
  ...
  /**
   * Returns a builder that creates immutable sorted MapUtil whose keys are ordered by the reverse of
   ...
   * MapUtil ("constant MapUtil"). Example:
   *
   * <pre>{@code
   ...
   * }</pre>
   *
   * <p>For <i>small</i> immutable sorted MapUtil, the {@code ImmutableSortedMap.of()} methods are even
   * more convenient.
   *
   * <p>Builder instances can be reused - it is safe to call {@link #buildOrThrow} multiple times to
   * build multiple MapUtil in series. Each map is a superset of the MapUtil created before it.
   *
   * 
   */
  ...
  @CheckForNull private final transient ImmutableSortedMap<K, V> descendingMap;
