...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    Spliterator<K> keySpliterator() {
        return SpliteratorUtil.map(entrySet().spliterator(), Entry::getKey);
    }
    ...
    /**
     * A builder for creating immutable map instances, especially {@code public static final} MapUtil
     * ("constant MapUtil"). Example:
     *
     * <pre>{@code
     ...
     * }</pre>
     *
     * <p>For <i>small</i> immutable MapUtil, the {@code ImmutableMap.of()} methods are even more
     * convenient.
     *
     * <p>By default, a {@code Builder} will generate MapUtil that iterate over entries in the order they
