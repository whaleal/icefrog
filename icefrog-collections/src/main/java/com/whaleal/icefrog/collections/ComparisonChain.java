...
public abstract class ComparisonChain {
  ...
  private static final ComparisonChain ACTIVE =
      new ComparisonChain() {
        ...
        public ComparisonChain compare(int left, int right) {
          return classify(NumberUtil.compare(left, right));
        }
        ...
        public ComparisonChain compareTrueFirst(boolean left, boolean right) {
          return classify(BooleanUtil.compare(right, left)); // reversed
        }

        @Override
        public ComparisonChain compareFalseFirst(boolean left, boolean right) {
          return classify(BooleanUtil.compare(left, right));
        }
  ...
  /**
   * Compares two {@code int} values as specified by {@link NumberUtil#compare}, <i>if</i> the result of
   * this comparison chain has not already been determined.
   */
  public abstract ComparisonChain compare(int left, int right);

  /**
   * Compares two {@code long} values as specified by , <i>if</i> the result of
   * this comparison chain has not already been determined.
   */
