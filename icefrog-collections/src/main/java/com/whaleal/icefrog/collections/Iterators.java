...
public final class Iterators {
    ...
    public static int size( Iterator<?> iterator ) {
        ...
        return (int) NumberUtil.saturatedCast(count, Integer.class);
    }
    ...
    public static <T extends Object> Iterator<T> cycle( T... elements ) {
        return cycle(ListUtil.list(false, elements));
    }
     ...
     * array whose contents are initially non-null. The {@code } annotation indicates that
    ...
    // Class.isInstance
    public static <T> AbstractIterator<T> filter( Iterator<?> unfiltered, Class<T> desiredType ) {
        return (AbstractIterator<T>) filter(unfiltered, instanceOf(desiredType));
    }
