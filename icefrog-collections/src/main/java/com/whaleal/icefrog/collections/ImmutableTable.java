...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V>
    ...
    public ImmutableMap<C, V> row( R rowKey ) {
        checkNotNull(rowKey, "rowKey");
        return ArrayUtil.firstNonNull(
                (ImmutableMap<C, V>) rowMap().get(rowKey), ImmutableMap.of());
    }
    ...
    public static final class Builder<R, C, V> {
        private final List<Cell<R, C, V>> cells = ListUtil.list(false);
        @CheckForNull
        ...
        public ImmutableTable<R, C, V> buildOrThrow() {
            ...
            switch (size) {
                case 0:
                    return of();
                case 1:
                    return new SingletonImmutableTable<>(IterUtil.getOnlyElement(cells));
                default:
